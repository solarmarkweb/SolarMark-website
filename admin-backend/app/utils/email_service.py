...
def send_review_update_notification(
    ...
    subject = f"🔍 Review Update: {filename}"
    
    status_color = "#f59e0b" if status.lower() == "pending" else "#22c55e" if status.lower() == "completed" else "#3b82f6"
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border: 1.5px solid #e2e8f0; border-radius: 14px; overflow: hidden; margin-bottom: 32px;">
            <tr>
                <td style="padding: 20px 24px;">
                    <p style="margin: 0; font-size: 10px; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; color: #94a3b8;">Admin Feedback / Remarks</p>
                    <p style="margin: 10px 0 0; font-size: 15px; color: #334155; line-height: 1.6; white-space: pre-wrap;">{admin_remarks}</p>
                </td>
            </tr>
        </table>
        """
                ...
                <td align="center">
                    <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
                        ...
                        <tr>
                            <td style="padding: 48px 40px 32px;">
                                <div style="text-align: center; margin-bottom: 32px;">
                                    <div style="display: inline-block; width: 72px; height: 72px; background-color: #eff6ff; border-radius: 20px; line-height: 72px; font-size: 36px; margin-bottom: 20px;">
                                        🔍
                                    </div>
                                    <h2 style="margin: 0; font-size: 22px; font-weight: 800; color: #0f172a;">
                                        Your Report Review Was Updated
                                                        <p style="margin: 8px 0 0; font-size: 15px; color: #64748b;">
                                        Hello <strong style="color: #0f172a;">{user_name}</strong>, an admin has updated the review status for your report.
                                    </p>
                                </div>
                                <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border: 1.5px solid #e2e8f0; border-radius: 14px; overflow: hidden; margin-bottom: 32px;">
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="padding: 18px 24px;">
                                            <p style="margin: 0; font-size: 10px; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; color: #94a3b8;">Current Status</p>
                                            <p style="margin: 6px 0 0; font-size: 14px; font-weight: 800; color: {status_color}; text-transform: uppercase;">
                                                {status}
                                            </p>
                                        </td>
                                    </tr>
                                ...
                                {remarks_html}
                                <div style="text-align: center; margin-bottom: 32px;">
                                    <a href="https://solarmark.in/profile" style="display: inline-block; padding: 14px 36px; background: linear-gradient(135deg, #f97316, #ea580c); color: #ffffff; font-size: 14px; font-weight: 800; letter-spacing: 0.5px; text-decoration: none; border-radius: 12px; box-shadow: 0 4px 14px rgba(249, 115, 22, 0.4);">
                                        View Details →
                                    </a>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td style="background-color: #f8fafc; border-top: 1px solid #e2e8f0; padding: 28px 40px; text-align: center;">
                                <p style="margin: 0; font-size: 12px; color: #94a3b8;">© 2026 SolarMark. All rights reserved.</p>
                            </td>
                        </tr>
                    </table>
                </td>
...
def send_report_shared_notification(
    recipient_email: str,
    sender_name: str,
    filename: str,
    pdf_id: str
) -> tuple[bool, str]:
    subject = f"📂 A SolarMark Report has been shared with you"
            ...
            <tr>
                <td align="center">
                    <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
                        <tr>
                            <td style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); padding: 40px 40px 32px; text-align: center;">
                                <h1 style="margin: 0; font-size: 28px; font-weight: 900; color: #ffffff;">Solar<span style="color: #f97316;">Mark</span></h1>
                            </td>
                        </tr>
                        <tr><td style="background: linear-gradient(90deg, #f97316, #ea580c); height: 4px;"></td></tr>
                        <tr>
                            <td style="padding: 48px 40px 32px;">
                                <div style="text-align: center; margin-bottom: 32px;">
                                    <div style="display: inline-block; width: 72px; height: 72px; background-color: #eff6ff; border-radius: 20px; line-height: 72px; font-size: 36px; margin-bottom: 20px;">📂</div>
                                    <h2 style="margin: 0; font-size: 22px; font-weight: 800; color: #0f172a;">New Shared Report</h2>
                                    <p style="margin: 8px 0 0; font-size: 15px; color: #64748b;">
                                        <strong style="color: #0f172a;">{sender_name}</strong> has shared a solar inspection report with you.
                                    </p>
                                </div>
                                <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border: 1.5px solid #e2e8f0; border-radius: 14px; overflow: hidden; margin-bottom: 32px;">
                                    <tr>
                                ...
                                <div style="text-align: center;">
                                    <p style="margin-bottom: 24px; font-size: 14px; color: #64748b;">You can view this report in the "Shared with Me" section of your profile.</p>
                                    <a href="https://solarmark.in/profile" style="display: inline-block; padding: 14px 36px; background: linear-gradient(135deg, #f97316, #ea580c); color: #ffffff; font-size: 14px; font-weight: 800; text-decoration: none; border-radius: 12px; box-shadow: 0 4px 14px rgba(249, 115, 22, 0.4);">View Report Details</a>
                                </div>
                            </td>
                        </tr>
                        <tr><td style="background-color: #f8fafc; border-top: 1px solid #e2e8f0; padding: 28px 40px; text-align: center;"><p style="margin: 0; font-size: 12px; color: #94a3b8;">© 2026 SolarMark. All rights reserved.</p></td></tr>
                    </table>
                </td>
            </tr>
        </table>
...
class EmailService:
    ...
    def send_report_shared_notification(self, *args, **kwargs):
        return send_report_shared_notification(*args, **kwargs)
